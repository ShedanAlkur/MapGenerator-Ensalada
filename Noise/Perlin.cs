...
namespace Noise.Perlin
{
    ...
    public class Perlin
    {
        ...
        public double Noise(double fx, double fy)
        {
            ...
            //t = pointInQuadY
            //a = Lerp(pointInQuadX, ftx1, ftx2) = ftx1 + pointInQuadX * (ftx2 - ftx1)
            //b = Lerp(pointInQuadX, fbx1, fbx2) = fbx1 + pointInQuadX * (fbx2 - fbx1)
